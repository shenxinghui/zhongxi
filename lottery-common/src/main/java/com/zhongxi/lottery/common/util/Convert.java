...
import com.zhongxi.lottery.common.constant.enumeration.BasicTypeEnum;
...
public class Convert {
	...
	public static Object parse(Class<?> clazz, Object value) {
		try {
			...
			if (Date.class.isAssignableFrom(clazz)) {
				// 判断标准日期
				return DateUtils.parse(valueStr);
	...
	public static Object parseBasic(Class<?> clazz, String valueStr) {
		...
		BasicTypeEnum basicType = null;
		try {
			basicType = BasicTypeEnum.valueOf(clazz.getSimpleName().toUpperCase());
		} catch (Exception e) {
			// 非基本类型数据
			return null;
		}
	...
	public static String toHex(String str) {
		return HexUtils.encodeHexStr(str.getBytes());
	}
